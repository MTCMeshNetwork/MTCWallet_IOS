...
#if __IPHONE_OS_VERSION_MAX_ALLOWED >= 80000
                    [strongSelf.hudVibrancyView.contentView insertSubview:strongSelf.ringView atIndex:0];
#else
...
#if __IPHONE_OS_VERSION_MAX_ALLOWED >= 80000
                    [strongSelf.hudVibrancyView.contentView insertSubview:strongSelf.backgroundRingView atIndex:0];
#else
...
#if __IPHONE_OS_VERSION_MAX_ALLOWED >= 80000
                [strongSelf.hudVibrancyView.contentView insertSubview:strongSelf.indefiniteAnimatedView atIndex:0];
#else
